...
do $$ begin
  ...
  if not exists (
    ...
    create policy intent_routes_read on public.intent_routes for select to anon, authenticated using (true);
...
do $$ begin
  ...
  if not exists (
    ...
    create policy intent_routes_insert_service on public.intent_routes for insert to service_role with check (true);
  ...
  if not exists (
    ...
    create policy intent_routes_update_service on public.intent_routes for update to service_role using (true) with check (true);
  ...
  if not exists (
    ...
    create policy intent_routes_delete_service on public.intent_routes for delete to service_role using (true);
